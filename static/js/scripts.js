  ...
  //handler for the "delete all" button
    ...
    var handlePick = function(){
      $('.pick').on('click', function(){
        ...
        var pick = Math.floor((Math.random() * items.length) + 0);
        console.log("pick: " + pick);
        console.log("id: " + items[pick]);
        var text = localStorage.getItem(items[pick]);
        console.log("text: " + text);
        $( ".winner" ).append( '<h3> Looks like this is the winner! </h3> <li class="winner" style="height:25px;">' + text + '</li>');
